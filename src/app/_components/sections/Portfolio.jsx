...
import { FaExternalLinkAlt, FaExternalLinkSquareAlt, FaBehance, FaGithub } from "react-icons/fa";

const PortfolioSection = ({
  heading = { subtitle: "", title: "", description: "" },
  paddingTop = 120,
  paddingBottom = 60,
  projects,
  order,
  ...
  const defaultOrder = [
    "Project-1", // Project Management Dashboard (Code)
    "Project-2", // E-learning Platform (UI/UX)
    "Project-4", // Travel Agency App (Code)
    "Project-3", // Online Banking Redesign (UI/UX)
    "Project-6", // Movie Info Landing Page (Code)
    "Project-5"  // Food Delivery App (UI/UX)
  ];

  const renderOrder = order || defaultOrder;

  // Create key-object map
  let projectsKeys = {};
            ...
            <div className="col-12 mil-mb30">
              <span
                ...
                dangerouslySetInnerHTML={{
                  __html: heading.subtitle ? heading.subtitle : Data.subtitle
                }}
              />
              <h2
                className="mil-fs42 mil-up"
                dangerouslySetInnerHTML={{
                  __html: heading.title ? heading.title : Data.title
                }}
              />
            </div>
            ...
            <div className="">
              <div className="">
                <div className="container-fluid">
                  <p
                    className="mil-text mil-fs16 mil-mb30 mil-up"
                    dangerouslySetInnerHTML={{
                          ...
                          >
                            ...
                            <div className="card-body d-flex flex-column justify-content-between p-4">
                              <div className="gap-3 mb-3">
                                <p className="mil-tag-text mb-2 text-muted" style={{ fontSize: '0.7rem' }}>
                                  {project.category}
                                </p>
              ...
              <div className="mil-project-btn-frame mil-up flex gap-4" style={{ paddingBottom: "120px" }}>
